...
configs = {
    ...
    'LiquidFun_train' : Config(
        ...
        n_instance = 1, n_stages = 1,
        neighbor_radius = 0.025 * 2 * 1.1,  # 0.025 * 2.0 * 0.9,  # 0.08 / 0.05 * 0.025,
        instance = [0, ],
        root_num = [None, ],
        material = ['fluid', ],
    ...
    'LiquidFun_300_train' : Config(
        ...
        attr_dim = 1,
        relation_dim = 1,
        time_step = 301, time_step_clip = 100,
        n_instance = 1, n_stages = 1,
    ...
    'LiquidFun_300_eval' : Config(
        ...
        attr_dim = 1,
        relation_dim = 1,
        time_step = 151, time_step_clip = 100,
        n_instance = 1, n_stages = 1,
        neighbor_radius = 0.08 / 0.05 * 0.025,
        instance = [0, ],
        root_num = [None, ],
    ...
    'LiquidFun_300_radius0.055_train' : Config(
        env = 'LiquidFun_300',
        n_rollout = 3000,
        batch_size = 1,
        n_epoch = 5,
        ...
        n_instance = 1, n_stages = 1,
        neighbor_radius = 0.025 * 2 * 1.1,
        instance = [0, ],
        root_num = [None, ],
        material = ['fluid', ],
        outf = os.path.join('data', 'test_LiquidFun_300_radius0.055')
    ),
    'LiquidFun_300_radius0.055_eval' : Config(
        env = 'LiquidFun_300',
        n_rollout = 3000,
        batch_size = 1,
        eval = True, # evaluation on
    ...
    'LiquidFun_radius0.02_train' : Config(
        env = 'LiquidFun',
        n_rollout = 3000,
        batch_size = 1,
        n_epoch = 5,
        ...
        root_num = [None, ],
        material = ['fluid', ],
        outf = os.path.join('data', 'test_LiquidFun_radius0.02')
    ),
    'LiquidFun_radius0.02_eval' : Config(
        env = 'LiquidFun',
        n_rollout = 3000,
        batch_size = 1,
        eval = True, # evaluation on
    ...
    'LiquidFun_300_radius0.05_train' : Config(
        env = 'LiquidFun_300',
        n_rollout = 3000,
        batch_size = 1,
        n_epoch = 5,
        ...
        root_num = [None, ],
        material = ['fluid', ],
        outf = os.path.join('data', 'test_LiquidFun_300_radius0.05')
    ),
    'LiquidFun_300_radius0.05_eval' : Config(
        env = 'LiquidFun_300',
        n_rollout = 3000,
        batch_size = 1,
        eval = True, # evaluation on
    ...
    'LiquidFun_300_radius0.05_clip35_train' : Config(
        env = 'LiquidFun_300',
        n_rollout = 3000,
        batch_size = 1,
        n_epoch = 5,
        ...
        attr_dim = 1,
        relation_dim = 1,
        time_step = 301, time_step_clip = 35,
        n_instance = 1, n_stages = 1,
        neighbor_radius = 0.025 * 2,
        instance = [0, ],
        root_num = [None, ],
        material = ['fluid', ],
        outf = os.path.join('data', 'test_LiquidFun_300_radius0.05_clip35')
    ),
    'LiquidFun_300_radius0.05_clip35_eval' : Config(
        env = 'LiquidFun_300',
        n_rollout = 3000,
        batch_size = 1,
        eval = True, # evaluation on
